<template>
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
      ...
      <div class="text-sm text-slate-500 dark:text-slate-400 text-center sm:text-left">
        Showing <span class="button font-medium text-slate-600 dark:text-slate-300">1</span> to <span class="font-medium text-slate-600 dark:text-slate-300">10</span> of <span class="font-medium text-slate-600 dark:text-slate-300">467</span> results
      </div>
    </div>
  </template>
